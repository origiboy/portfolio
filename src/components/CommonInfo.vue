<template>
    <div class="common">
        <div>
            ...
            <ul>
                <li><a href="#about" :class="{active: isActive('about')}">Обо мне</a></li>
                <li><a href="#skills" :class="{active: isActive('skills')}">Скиллы</a></li>
                <li><a href="#education" :class="{active: isActive('education')}">Образование</a></li>
                <li><a href="#experience" :class="{active: isActive('experience')}">Опыт работы</a></li>
            </ul>
        </div>
        <div class="common__contacts">
            <a href="https://t.me/origiboy" target="_blank" class="common__contacts-telegram">Telegram: @origiboy</a>
            <a href="mailto:origiboy@yandex.ru" target="_blank" class="common__contacts-email">Email: origiboy@yandex.ru</a>
...
onMounted(() => {
    ...
    if (experience)
        experienceTop.value = experience.getBoundingClientRect().top

    const education = document.querySelector('#education')
    if (education)
        educationTop.value = education.getBoundingClientRect().top

    const skills = document.querySelector('#skills')
    if (skills)
        skillsTop.value = skills.getBoundingClientRect().top
})
</script>
